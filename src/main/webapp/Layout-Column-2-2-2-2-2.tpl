<div class="Layout-Column-10-2" id="main-content" role="main">
	<div class="portlet-layout row-fluid">
	
		<div class="portlet-column portlet-column-first span1" id="column-first">
		</div>
		...
		<div class="portlet-column portlet-column-last span1" id="column-last">
		</div>
	</div>
</div>
